        ...
        <div className="p-4 sm:p-6 lg:p-10 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <Link to="/admin/add-property" className="bg-blue-600 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">
                        + Add New Property
                    </Link>
                </div>
                        ...
                        <tbody>
                            {properties.map((property) => (
                                <tr key={property._id} className="border-b hover:bg-gray-50">
                                    <td className="p-4">
                                        <img src={property.mainImage} alt={property.title} className="w-20 h-16 object-cover rounded-md" />
                                    </td>
                                    ...
                                    <td className="p-4">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <Link to={`/admin/edit-property/${property._id}`} className="text-blue-600 hover:underline font-semibold">
                                                Edit ✏️
                                            </Link>
                                            <button onClick={() => handleDelete(property._id)} className="text-red-600 hover:underline font-semibold">
                                                Delete 🗑️
                                            </button>
                                        </div>
                                    </td>
